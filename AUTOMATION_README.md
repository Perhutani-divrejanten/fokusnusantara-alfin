...
- **email**: Email portal (akan replace "fokusnusantara@gmail.com")
- **socialHandle**: Handle social media (akan replace "fokusnusantara")
- **colors**: Tema warna
  - **primary**: Warna utama hijau (contoh: #065F46 → custom)
  - **dark**: Warna gelap dark green (contoh: #022C22 → custom)
...
| `fokusnusantara` | `siteName` (tanpa spaces) |
| `fokusnusantara` | `socialHandle` |
| `fokusnusantara@gmail.com` | `email` |
| `#065F46` (primary) | Warna primary dari config |
| `#022C22` (dark) | Warna dark dari config |
